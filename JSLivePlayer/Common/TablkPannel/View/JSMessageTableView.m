...
@implementation JSMessageNodeView
...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        //注册Cell
        [self registerClass:[JSMessageCell class] forCellReuseIdentifier:@"MessageCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    JSMessageCell *cell = [tableView dequeueReusableCellWithIdentifier:@"MessageCell" forIndexPath:indexPath];
    @try {
...
- (void)receiveNotification:(NSNotification *)notification {
    ...
    if ([string rangeOfString:@"type@=mrkl"].location == NSNotFound) {
        JSMessageModel *model = [JSMessageModel new];
