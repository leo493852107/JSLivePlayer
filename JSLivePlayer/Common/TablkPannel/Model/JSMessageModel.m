...
- (void)setModelFromStirng:(NSString *)string {
    ...
    switch (self.cellType) {
        case CellNewChatMessageType:
        {
            ...
            textStorage.textColor = JSRGBAColor(30, 153, 247, 1);
        ...
        case CellNewGiftType:
        {
            ...
            nameTextStorage.textColor = JSRGBAColor(30, 153, 247, 1);
        ...
        case CellNewUserEnterType:
        {
            ...
            nameTextStorage.textColor = JSRGBAColor(257, 100, 113, 1);
            nameTextStorage.font = [UIFont systemFontOfSize:15];
            [container addTextStorage:nameTextStorage];
        ...
        case CellBanType:
        {
            ...
            container.textColor = JSRGBAColor(257, 100, 113, 1);
        ...
        case CellDeserveType:
        {
            ...
            deserveTextStorage.textColor = JSRGBAColor(198, 53, 150, 1);
...
- (void)setModel:(NSString *)userID withName:(NSString *)name withIcon:(NSString *)icon withType:(CellType)type withMessage:(NSString *)message {
    ...
    switch (type) {
        case CellNewChatMessageType:
        {
            ...
            [container addLinkWithLinkData:userID linkColor:JSRGBAColor(30, 153, 247, 1) underLineStyle:kCTUnderlineStyleNone range:[allMessage rangeOfString:name]];
