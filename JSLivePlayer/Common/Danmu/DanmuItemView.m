...
- (void)setContent:(DanmuItem*)model{
    ...
    NSString *thumUrl = [[BmobUser currentUser] objectForKey:@"userIcon"] == nil ? @"" : [[BmobUser currentUser] objectForKey:@"userIcon"];
    // 头像
    [headImage sd_setImageWithURL:[NSURL URLWithString:thumUrl]];
